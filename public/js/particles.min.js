...
/* v2.0.0
/* Modified with light dark purple background
/* ----------------------------------------------- */
function hexToRgb(e) {
...
var pJS = function (e, a) {
    ...
    a && Object.deepExtend(i, a),
        ...
        (i.fn.canvasPaint = function () {
            // Set darker purple background
            i.canvas.ctx.fillStyle = "#2D1B4E"; // Darker purple color
        ...
        (i.fn.particlesDraw = function () {
            // Apply the purple background before clearing
            i.fn.canvasPaint();
